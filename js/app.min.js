...
window.addEventListener("load", function () {
    ...
    if (pageHash) {
        ...
        const targetBlock = document.querySelector('.' + pageHash.replace('#', ''));
        if (targetBlock) {
...
if (document.querySelector('.gallery-popup__slider-body')) {
    new Swiper('.gallery-popup__slider-body', {
        ...
        // Arrows
        navigation: {
            nextEl: '.gallery-popup__nav .gallery-popup__arrow_next',
            prevEl: '.gallery-popup__nav .gallery-popup__arrow_prev',
        },
    });
}
if (document.querySelector('.channel__slider-body')) {
    new Swiper('.channel__slider-body', {
        observer: true,
        observeParents: true,
        speed: 800,
        watchOverflow: true,
...
// function _goto(target_block, speed, offset = document.querySelector('.header__wrapper').offsetHeight + 1) {
function _goto(target_block, speed, offset = 1) {
